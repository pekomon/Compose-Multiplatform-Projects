...
class HistoryStoreTest {
    ...
    @Test
    fun resultsAreIsolatedPerDifficulty() =
        runTest {
            store.clearAll()
...
private class FakeHistoryStore : HistoryStore {
    ...
    override suspend fun getTop10(difficulty: Difficulty): List<RunRecord> = data[difficulty].orEmpty()
